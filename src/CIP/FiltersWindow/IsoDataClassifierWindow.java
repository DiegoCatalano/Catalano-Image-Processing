...
import CIP.Main;
import Catalano.Imaging.Filters.IsoDataClassifier;
 ...
 * @author Diego
 */
public class IsoDataClassifierWindow extends javax.swing.JFrame {
     ...
     */
    public IsoDataClassifierWindow() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("IsoData Classifier");

        sldRadius.setMaximum(20);
        sldRadius.setMinimum(1);
        sldRadius.setValue(3);
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        int x = sldRadius.getValue();
        Main.ApplyFilter(new IsoDataClassifier(x));
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IsoDataClassifierWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
