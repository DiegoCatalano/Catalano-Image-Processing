 ...
 * @author Diego
 */
public class HistogramStretchWindow extends javax.swing.JFrame {
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        Main.ApplyFilter(new HistogramStretch(sldMin.getValue(), sldMax.getValue()));
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistogramStretchWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistogramStretchWindow().setVisible(true);
            }
        });
    }
