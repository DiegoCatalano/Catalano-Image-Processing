 ...
 * @author Diego
 */
public class ImageQuantizationWindow extends javax.swing.JFrame {
     ...
     */
    public ImageQuantizationWindow() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        sldRadius.setMaximum(8);
        sldRadius.setMinimum(1);
        sldRadius.setValue(6);
    ...
    private void sldRadiusStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sldRadiusStateChanged
        int x = (int)Math.pow(2, sldRadius.getValue());
        lblValue.setText(String.valueOf(x));
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        int x = (int)Math.pow(2, sldRadius.getValue());
        Main.ApplyFilter(new ImageQuantization(x));
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImageQuantizationWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
