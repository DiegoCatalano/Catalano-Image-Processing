 ...
 * @author Diego
 */
public class ThresholdWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sldRadius.setMaximum(255);
        sldRadius.setValue(127);
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        Main.ApplyFilter(new Threshold(sldRadius.getValue()));
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThresholdWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThresholdWindow().setVisible(true);
            }
        });
    }
